...
public class SetObstaclesActivity extends AppCompatActivity
    ...
    final List<Polygon> listObstacles = new ArrayList<Polygon>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_obstacles);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        for(int i = 0; i < MapsActivityCurrentPlace.listPolygons.size(); i++){
            listObstacles.add(mMap.addPolygon(rectOptions));
            listObstacles.get(i).setPoints(MapsActivityCurrentPlace.listPolygons.get(i));
            listObstacles.get(i).setClickable(true);
        }
        ...
        mMap.setOnPolygonClickListener(new GoogleMap.OnPolygonClickListener() {
            public void onPolygonClick(Polygon polygon) {
                for(int i = 0; i < listObstacles.size(); i++){
                    if(polygon.equals(listObstacles.get(i))){
